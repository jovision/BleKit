package com.jovisionapp.blekit.ble.bluetooth;
...
import com.jovisionapp.blekit.ble.callback.BleGattCallback;
import com.jovisionapp.blekit.ble.callback.BleIndicateCallback;
import com.jovisionapp.blekit.ble.callback.BleMtuChangedCallback;
import com.jovisionapp.blekit.ble.callback.BleNotifyCallback;
import com.jovisionapp.blekit.ble.callback.BleReadCallback;
import com.jovisionapp.blekit.ble.callback.BleRssiCallback;
import com.jovisionapp.blekit.ble.callback.BleWriteCallback;
import com.jovisionapp.blekit.ble.data.BleConnectStateParameter;
import com.jovisionapp.blekit.ble.data.BleDevice;
import com.jovisionapp.blekit.ble.data.BleMsg;
import com.jovisionapp.blekit.ble.exception.ConnectException;
import com.jovisionapp.blekit.ble.exception.OtherException;
import com.jovisionapp.blekit.ble.exception.TimeoutException;
...
public class BleBluetooth {
    ...
    private BluetoothGattCallback coreGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            // 当设备响应写入操作时触发
            if (status == BluetoothGatt.GATT_SUCCESS) {
                // 写入成功，你可以在 characteristic 中获取设备的响应数据
